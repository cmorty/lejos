...
/**
 * Added non-functional UnidirectionalPilot with three methods under Lawrie's instructions. I applaud the idea that we would 
 ...
 * 
 * However: Some robots probably can't go backward. So maybe we should have Pilot or UnidirectionalPilot that can change heading, and
 ...
 *
 */
public interface UnidirectionalPilot {
	/**
