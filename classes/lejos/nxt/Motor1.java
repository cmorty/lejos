...
/**
 * works with  proposal.DifferentialMoveControl as its listener
...
{   
  ...
  private Motor1 _thisMotor = this; // alias  for use by regulator

  /**
    * Motor A.
    */
   public static final Motor1 A = new Motor1 (MotorPort.A);

   /**
    * Motor B.
    */
   public static final Motor1 B = new Motor1 (MotorPort.B);

   /**
    * Motor C.
    */
   public static final Motor1 C = new Motor1 (MotorPort.C);
    ...
    */
   public Motor1 (TachoMotorPort port)
   {
      _port = port;
   ...
   public void rotateTo(int limitAngle,boolean immediateReturn)
   {
      ...
      synchronized(regulator)
      {
         ...
         int os = overshoot(_limitAngle - getTachoCount());
      _stopAngle = _limitAngle - _direction * os;//overshoot(limitAngle - getTachoCount());
         _rotating = true;
         _newOperation = false;
         _rotationPending = immediateReturn;
      }
   ...
   public class Regulator extends Thread
   {
     ...
     int error = 0;
      ...
      {  
         ...
         while ( k < 40 && !Motor1.this._newOperation)
         {
      ...
      if (listener != null && _rotationPending)
      {
        listener.rotationStopped(_thisMotor, getTachoCount(),0);
      }
