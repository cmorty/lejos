...
#ifndef UART_POLLED
static void uart_process_isr(U32 u)
{
  struct soft_uart *p;
  volatile struct _AT91S_USART *up;
...
int  uart_init(U32 u, U32 baudRate, U32 dataBits, U32 stopBits, char parity)
{
 ...
 p = &uart[u];
  ...
  switch(dataBits)
  {
    case 7: mode |= 0x80; break;
    case 8: mode |= 0xc0; break;
    default: error = 1;
  }

  switch(stopBits)
  {
    case 1:           mode |= 0x00000000; break;
    case 15: 	      mode |= 0x00001000; break;
    case 2:          mode |= 0x00002000; break;
    default: error = 1;
  }

  switch(parity)
  {
    case 'N'  :  mode |= 0x00000800; break;
    case 'O' :  mode |= 0x00000200; break;
    case 'E':  mode |= 0x00000000; break;
    case 'M':  mode |= 0x00000600; break;
    case 'S': mode |= 0x00000400; break;
    default: error = 1;
  }
