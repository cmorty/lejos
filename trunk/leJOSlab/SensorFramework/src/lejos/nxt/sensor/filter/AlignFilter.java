 ...
 * 
 * For example. If a robot has an US sensor attached that is pointing to the sensorA then the filter should be configured using
 ...
 * This indicates that the object is 70.7 cm in front of the robot and 70.7 cm to the sensorA of the robot.
 * @author Aswin
 *
 */
