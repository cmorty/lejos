...
:home_unset
	...
	goto :home_endif
:home_unset_nt
	call :home_nt_normalize NXJ_BIN "%~dp0\."
	call :home_nt_normalize NXJ_HOME "%~dp0\.."
	goto :home_endif
:home_nt_normalize
	set "%1=%~f2"
	goto :eof
...
java -Dnxj.home="%NXJ_HOME%" -DCOMMAND_NAME="nxjlink" -Djava.library.path="%NXJ_BIN%" -classpath "%NXJ_CP_TOOL%" js.tinyvm.TinyVM --bootclasspath "%NXJ_CP_BOOT%" --writeorder "LE" --classpath "." %*
:EOF
