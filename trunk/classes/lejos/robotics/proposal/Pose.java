...
{
/**
   * allocate a new Pose at the origin, heading  = 0:the direction  the positive X axis <br>
 *  This Pose will no be automatically updated when the robot moves unless you
 * 
   */
  Pose()
  {
   ...
   * @param moveController  the MoveProvider that will update this pose automatically
   */
  public Pose(MoveProvider moveController )
  {
   ...
   * @param moveController  the MoveProvider that will update this pose automatically
   */
  public Pose(MoveProvider moveController, float x, float y, float heading)
  {
...
/**
 * called by MoveProvider when it starts a movement
 ...
 */
  ...
  /**
   * This method is called by a MoveProvider when requested and when a movement is complete.
 ...
 public void rotateUpdate(float angle)
  ...
  public void setprovider(MoveProvider moveController)
  {
    _provider = moveController;
  }
...
//  public enum Move {TRAVEL,ROTATE,ARC,NONE}
  ...
  protected MoveProvider _provider;
