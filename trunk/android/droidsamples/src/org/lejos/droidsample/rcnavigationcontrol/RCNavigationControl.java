package org.lejos.droidsample.rcnavigationcontrol;
...
public class RCNavigationControl extends TabActivity {
	...
	class UIMessageHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				...
				case DroidSamples.MESSAGE:
					//Log.d(TAG, (String) msg.getData().get(LeJOSDroid.MESSAGE_CONTENT));
					mMessage.setText((String) msg.getData().get(DroidSamples.MESSAGE_CONTENT));
					break;
	...
	private class ConnectThread extends Thread {
		...
		public void run() {
			...
			if (!communicator.connect(name.toString(), null)) {
