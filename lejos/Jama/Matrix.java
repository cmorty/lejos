 ...
 * ------------------------ */
   ...
   */
   ...
   public Matrix (double vals[], int m) throws Exception {
      this.m = m;
      n = (m != 0 ? vals.length/m : 0);
      if (m*n != vals.length) {
         throw new Exception("Array length must be a multiple of m.");//IllegalArgumentException("Array length must be a multiple of m.");
      }
      A = new double[m][n];
      for (int i = 0; i < m; i++) {
         for (int j = 0; j < n; j++) {
 ...
 * ------------------------ */
   ...
   */
   ...
   public static Matrix constructWithCopy(double[][] A) throws Exception{
      int m = A.length;
      int n = A[0].length;
   ...
   */
   ...
   public Matrix getMatrix (int i0, int i1, int j0, int j1) throws Exception{
