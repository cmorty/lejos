 ...
 **/
public class TestPilot implements ArcRotatePilot {
	 ...
	 */
	public TestPilot(final float wheelDiameter, final float trackWidth,
	 ...
	 *            running backward.
	 */
	public TestPilot(final float leftWheelDiameter,
	...
	private float _distance0, _angle0;
	
	private void prepareMovement() {
		_distance0 = getTravelDistance();
		_angle0 = getAngle();
	}
	...
	public void endMovement() {
		...
		lastMovement = new Movement(MovementType.TRAVEL, d, a);		
