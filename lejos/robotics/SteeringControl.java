...
*  Example:<p>
* <code><pre>
*	SteeringControl sc = new SteeringControl(2.1f,4.4f,Motor.A, Motor.C,true);
...
*/
	public SteeringControl(float wheelDiameter,float trackWidth,Motor leftMotor, Motor rightMotor)
	{
		_left = leftMotor;
		_right = rightMotor;
 ...
 */
	public SteeringControl(float wheelDiameter,float trackWidth,Motor leftMotor, Motor rightMotor, boolean reverse)
	{
 ...
 * @parameter immediateReturn :if true this method returns immediately 
 */
